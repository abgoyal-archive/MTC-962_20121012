...
#elif defined(CONFIG_BCM_LCD_ILI9486)
#include "../../displays/lcd_ILI9486.h"
#elif defined(CONFIG_BCM_LCD_HX8357C)
#include "../../displays/lcd_HX8357C.h"
#elif defined(CONFIG_BCM_LCD_ILI9486L)
#include "../../displays/lcd_ILI9486L.h"
