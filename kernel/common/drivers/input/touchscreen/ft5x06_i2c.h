...
extern int ft5x06_i2c_rxdata(int txlen, unsigned char *rxdata, int length);
extern char read_reg(unsigned char addr);
extern struct i2c_client *ft5x06_client;
//extern int32_t ft5x06_i2c_txdata(unsigned short saddr, unsigned char *txdata, int length);
