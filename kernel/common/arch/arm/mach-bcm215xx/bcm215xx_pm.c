...
//modify for bug323677, official patch from brcm case563964
//#define WAKEUP_SRC_GRP0	((1 << IRQ_KEYPAD) | (1 << IRQ_GPIO) | (1 << IRQ_GPT1) | (1 << IRQ_MICON))
#define WAKEUP_SRC_GRP0	((1 << IRQ_KEYPAD) | (1 << IRQ_GPIO) | (1 << IRQ_GPT1) | (1 << IRQ_MICON) | (1 << IRQ_MICIN))
