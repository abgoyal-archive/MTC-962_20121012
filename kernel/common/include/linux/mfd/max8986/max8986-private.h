...
/* MAXIM PMU Revision */
enum {
	MAXIM_PMU_MAX8986_R2 = 0x12,
	MAXIM_PMU_MAX8986_R4 = 0x32,
	MAXIM_PMU_MAX8999_R0 = 0x13,
};
...
struct max8986_power_pdata
{
	...
	u8 wac_charging_cc;
	u8 eoc_current;
	u8 charging_cv; // [Alvin 2011.09.08]

	struct batt_level_tbl batt_lvl_tbl_dischg; // [Alvin 2012.03.30]
	struct batt_level_tbl batt_lvl_tbl_chg;
	u8 batt_technology;
};
