...
enum {
	...
	CAM_CMD_SET_START_MODE,/* Modified by yubin */
	...
	CAM_CMD_SET_ZOOM,
	CAM_CMD_GET_PHY_ZOOM_ADDR,
        CAM_CMD_GET_DATA,
	CAM_CMD_GET_CAPTURE_TYPE,
...
#define	CAM_IOCTL_SET_EXPOSURE		_IOW(BCM_CAM_MAGIC, CAM_CMD_SET_EXPOSURE, CAM_Parm_t)
...
#define CAM_IOCTL_SET_START_MODE	_IOW(BCM_CAM_MAGIC, CAM_CMD_SET_START_MODE, CamStartMode_t)/* Modified by yubin */
/* ] */
...
#define CAM_IOCTL_PHY_ZOOM_ADDR _IOWR( BCM_CAM_MAGIC, CAM_CMD_GET_PHY_ZOOM_ADDR, CAM_Frame_t )
#define CAM_IOCTL_GET_DATA _IOWR( BCM_CAM_MAGIC, CAM_CMD_GET_DATA, CAM_Frame_t )
#define CAM_IOCTL_GET_CAPTURE_TYPE _IOWR( BCM_CAM_MAGIC, CAM_CMD_GET_CAPTURE_TYPE, CAM_Frame_t )
...
typedef enum {
	...
	CamZoom_2_2 = 116,	/* /< zoom factor 2.2    (256/116) *//* Modified by yubin */
	CamZoom_2_66 = 96,	/* /< zoom factor 2.66   (256/96) */
	CamZoom_2_8 = 91,	/* /< zoom factor 2.8    (256/91) *//* Modified by yubin */
	CamZoom_3_4 = 75,	/* /< zoom factor 3.4   (256/75) *//* Modified by yubin */
...
typedef enum {
	 CamSM_OpenCamera = 10,
	 CamSM_OpenVideo = 20,
	 CamSM_Camera2Video = 30,
	 CamSM_Video2Camera = 40,
	 CamSM_Poweoff = 50,
	 CamSM_Error = 0
} CamStartMode_t;
...
typedef struct {
	...
	CamZoom_t zoom;
	int exposure;       /*brightness exposure */
} CAM_Parm_t;
