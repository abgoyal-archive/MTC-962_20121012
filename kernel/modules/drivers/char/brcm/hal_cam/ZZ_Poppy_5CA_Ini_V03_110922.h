...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*/
//void Poppy_5CA_Ini_V03_110922(void)
...
//REV02 for Poppy\uff1aChange preview config0 preview size as 428*320, 
//                 Add Video preview config1:15fps,preview config2:30fps;
//                 add capture config 1:2M resolution,capture config 2:VGA resolution,
//REV03 for Poppy\uff1aChange capture config 2 as 1.3M resolution,and add capture config 3 as VGA
...
s5k5caga_i2c_write(0x0F12, 0x38A4); //30d4    //REG_TC_IPRM_OpClk4KHz_1     
...
s5k5caga_i2c_write(0x0F12, 0x38A4); //2904    //REG_TC_IPRM_OpClk4KHz_2      2   70000202 
s5k5caga_i2c_write(0x0F12, 0x5d80); //16f0    //REG_TC_IPRM_MinOutRate4KHz_2 2   70000204 
s5k5caga_i2c_write(0x0F12, 0x5e00); //17f0    //REG_TC_IPRM_MaxOutRate4KHz_2 2   70000206 
...
s5k5caga_i2c_write(0x0F12, 640/*0x01AC*/);   //REG_0TC_PCFG_usWidth        428
s5k5caga_i2c_write(0x0F12, 480/*0x0140*/);   //REG_0TC_PCFG_usHeight       320 2   7000026E    //             
...
s5k5caga_i2c_write(0x0F12, 0x0042);   //REG_0TC_PCFG_PVIMask         2   7000027A    //92  (1) PCLK inversion  (4)1b_C first (5) UV First           
...
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_usFrTimeType    2   70000284    //             
s5k5caga_i2c_write(0x0F12, 0x0001);   //REG_0TC_PCFG_FrRateQualityType             2   70000286    //             
s5k5caga_i2c_write(0x0F12, 666);   //REG_0TC_PCFG_usMaxFrTimeMsecMult10         2   70000288    //             
s5k5caga_i2c_write(0x0F12, 400);   //REG_0TC_PCFG_usMinFrTimeMsecMult10         2   7000028A    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_bSmearOutput    2   7000028C    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_sSaturation     2   7000028E    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_sSharpBlur      2   70000290    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_sColorTemp      2   70000292    //             
...
// # FPS :    30fps
//================================================================================================
s5k5caga_i2c_write(0x002A, 0x02CC);
s5k5caga_i2c_write(0x0F12, 0x0140);   //REG_0TC_PCFG_usWidth        
s5k5caga_i2c_write(0x0F12, 0x00F0);   //REG_0TC_PCFG_usHeight        2   7000026E    //             
s5k5caga_i2c_write(0x0F12, 0x0005);   //REG_0TC_PCFG_Format          2   70000270    //             
s5k5caga_i2c_write(0x0F12, 0x5e00); //591E   //REG_0TC_PCFG_usMaxOut4KHzRate             
s5k5caga_i2c_write(0x0F12, 0x5d80); //589E   //REG_0TC_PCFG_usMinOut4KHzRate             
s5k5caga_i2c_write(0x0F12, 0x0100);   //REG_0TC_PCFG_OutClkPerPix88  2   70000276    //             
s5k5caga_i2c_write(0x0F12, 0x0800);   //REG_0TC_PCFG_uMaxBpp88       2   70000278    //             
...
s5k5caga_i2c_write(0x0F12, 0x01E0);   //REG_0TC_PCFG_usJpegPacketSize              2   7000027E    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_usJpegTotalPackets            2   70000280    //             
s5k5caga_i2c_write(0x0F12, 0x0002); //0001   //REG_0TC_PCFG_uClockInd       2   70000282    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_usFrTimeType    2   70000284    //             
s5k5caga_i2c_write(0x0F12, 0x0001);   //REG_0TC_PCFG_FrRateQualityType             2   70000286    //             
s5k5caga_i2c_write(0x0F12, 0x014D);  //0190 //014D   //REG_0TC_PCFG_usMaxFrTimeMsecMult10         2   70000288    //             
s5k5caga_i2c_write(0x0F12, 0x014D);   //REG_0TC_PCFG_usMinFrTimeMsecMult10         2   7000028A    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_bSmearOutput    2   7000028C    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_sSaturation     2   7000028E    //             
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_PCFG_sSharpBlur      2   70000290    //             
...
s5k5caga_i2c_write(0x0F12, 0x0042);   //REG_0TC_CCFG_PVIMask         2   7000036C          //       
...
s5k5caga_i2c_write(0x0F12, 0x0000);   //REG_0TC_CCFG_uCaptureMode    2   7000035C
s5k5caga_i2c_write(0x0F12, 0x0640);   //REG_0TC_CCFG_usWidth         2   7000035E          //       
s5k5caga_i2c_write(0x0F12, 0x04B0);   //REG_0TC_CCFG_usHeight        2   70000360          //       
s5k5caga_i2c_write(0x0F12, 0x0005);   //REG_0TC_CCFG_Format          2   70000362          //       
s5k5caga_i2c_write(0x0F12, 0x591E); //32e8   //REG_0TC_CCFG_usMaxOut4KHzRate             
s5k5caga_i2c_write(0x0F12, 0x589E); //32a8   //REG_0TC_CCFG_usMinOut4KHzRate             
s5k5caga_i2c_write(0x0F12, 0x0100);   //REG_0TC_CCFG_OutClkPerPix88  2   70000368          //       
...
CAMERADBG( " ======V03 : Poppy_5CA_Ini_V03_110922 is OK====== \n" );
