...
void CAPI2_NetRegApi_SetSupportedRATandBand(ClientInfo_t* inClientInfoPtr, RATSelect_t RAT_cap, BandSelect_t band_cap, RATSelect_t RAT_cap2, BandSelect_t band_cap2)
{
	...
	req.req_rep_u.CAPI2_NetRegApi_SetSupportedRATandBand_Req.RAT_cap2 = RAT_cap2;
	req.req_rep_u.CAPI2_NetRegApi_SetSupportedRATandBand_Req.band_cap2 = band_cap2;
...
void CAPI2_SmsApi_StartCellBroadcastWithChnlReq(ClientInfo_t* inClientInfoPtr, MS_MN_CB_MSG_IDS *cbmi, MS_MN_CB_LANGUAGES *lang)
{
	CAPI2_ReqRep_t req;
	char* stream;
	UInt32 u32len;
...
void CAPI2_SmsApi_StartCellBroadcastForCMASReq(ClientInfo_t* inClientInfoPtr, MS_MN_CB_MSG_IDS *cbmi, MS_MN_CB_LANGUAGES *lang)
{
	CAPI2_ReqRep_t req;
	char* stream;
	UInt32 u32len;
	...
	req.req_rep_u.CAPI2_SmsApi_StartCellBroadcastForCMASReq_Req.cbmi = cbmi;
	req.req_rep_u.CAPI2_SmsApi_StartCellBroadcastForCMASReq_Req.lang = lang;
	req.respId = MSG_SMS_START_CB_FORCMAS_RSP;
	CAPI2_SerializeReqRspEx(&req, MSG_SMS_START_CB_FORCMAS_REQ, inClientInfoPtr, result, &stream, &u32len);
}
...
void CAPI2_MsDbApi_SYS_EnableCellInfoMsg(ClientInfo_t* inClientInfoPtr, Boolean inEnableCellInfoMsg)
{
	CAPI2_ReqRep_t req;
	char* stream;
	UInt32 u32len;
	...
	req.req_rep_u.CAPI2_MsDbApi_SYS_EnableCellInfoMsg_Req.inEnableCellInfoMsg = inEnableCellInfoMsg;
	req.respId = MSG_SYS_ENABLE_CELL_INFO_RSP;
	CAPI2_SerializeReqRspEx(&req, MSG_SYS_ENABLE_CELL_INFO_REQ, inClientInfoPtr, result, &stream, &u32len);
}
...
void CAPI2_SS_SendCallForwardReq(UInt32 tid, UInt8 clientID, SS_Mode_t mode, SS_CallFwdReason_t reason, SS_SvcCls_t svcCls, UInt8 waitToFwdSec, UInt8* number)
{
	...
	req.respId = MSG_SS_CALL_FORWARD_RSP;
...
void CAPI2_SS_SendCallBarringReq(UInt32 tid, UInt8 clientID, SS_Mode_t mode, SS_CallBarType_t callBarType, SS_SvcCls_t svcCls, UInt8* password)
{
	...
	req.respId = MSG_SS_CALL_BARRING_RSP;
...
void CAPI2_SS_SendCallWaitingReq(UInt32 tid, UInt8 clientID, SS_Mode_t mode, SS_SvcCls_t svcCls)
{
	...
	req.respId = MSG_SS_CALL_WAITING_RSP;
...
void CAPI2_NetRegApi_SetTZUpdateMode(ClientInfo_t* inClientInfoPtr, TimeZoneUpdateMode_t mode)
{
	...
	req.req_rep_u.CAPI2_NetRegApi_SetTZUpdateMode_Req.mode = mode;
	req.respId = MSG_TIMEZONE_SET_UPDATE_MODE_RSP;
	CAPI2_SerializeReqRspEx(&req, MSG_TIMEZONE_SET_UPDATE_MODE_REQ, inClientInfoPtr, result, &stream, &u32len);
}
...
void CAPI2_SimApi_GetAdData(ClientInfo_t* inClientInfoPtr)
{
	...
	req.respId = MSG_SIM_AD_DATA_RSP;
	CAPI2_SerializeReqRspEx(&req, MSG_SIM_AD_DATA_REQ, inClientInfoPtr, result, &stream, &u32len);
}
...
void CAPI2_SimApi_GetCurrentSimVoltage(ClientInfo_t* inClientInfoPtr)
{
	...
	req.respId = MSG_SIM_GET_CURRENT_SIM_VOLTAGE_RSP;
	CAPI2_SerializeReqRspEx(&req, MSG_SIM_GET_CURRENT_SIM_VOLTAGE_REQ, inClientInfoPtr, result, &stream, &u32len);
}
