...
bool_t xdr_MS_MN_CB_MSG_ID_RANGE(void* xdrs, MS_MN_CB_MSG_ID_RANGE *rsp)
{
	XDR_LOG(xdrs,"MS_MN_CB_MSG_ID_RANGE")

	if(
		_xdr_UInt16(xdrs, &rsp->start_pos,"start_pos") &&
		_xdr_UInt16(xdrs, &rsp->stop_pos,"stop_pos") &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_MS_MN_CB_MSG_ID_RANGE_LIST(void* xdrs, MS_MN_CB_MSG_ID_RANGE_LIST *rsp)
{
	XDR_LOG(xdrs,"MS_MN_CB_MSG_ID_RANGE_LIST")

	if(
		xdr_vector(xdrs, (caddr_t)(void*)rsp->A,30, sizeof(MS_MN_CB_MSG_ID_RANGE ), xdr_MS_MN_CB_MSG_ID_RANGE ) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_MS_MN_CB_MSG_IDS(void* xdrs, MS_MN_CB_MSG_IDS *rsp)
{
...
bool_t xdr_MS_MN_CB_LANGUAGE_LIST(void* xdrs, MS_MN_CB_LANGUAGE_LIST *rsp)
{
...
bool_t xdr_MS_MN_CB_LANGUAGES(void* xdrs, MS_MN_CB_LANGUAGES *rsp)
{
...
bool_t xdr_CAPI2_SmsApi_StartCellBroadcastWithChnlReq_Req_t(void* xdrs, CAPI2_SmsApi_StartCellBroadcastWithChnlReq_Req_t *rsp)
{
	...
	if(
		xdr_pointer(xdrs, (char**)(void*)&rsp->cbmi,sizeof( MS_MN_CB_MSG_IDS ), xdr_MS_MN_CB_MSG_IDS) &&
		xdr_pointer(xdrs, (char**)(void*)&rsp->lang,sizeof( MS_MN_CB_LANGUAGES ), xdr_MS_MN_CB_LANGUAGES) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SmsApi_StartCellBroadcastForCMASReq_Req_t(void* xdrs, CAPI2_SmsApi_StartCellBroadcastForCMASReq_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SmsApi_StartCellBroadcastForCMASReq_Req_t")
...
{
	XDR_LOG(xdrs,"CAPI2_MsDbApi_SYS_EnableCellInfoMsg_Req_t")
...
bool_t xdr_CAPI2_SS_SendCallBarringPWDChangeReq_Req_t(void* xdrs, CAPI2_SS_SendCallBarringPWDChangeReq_Req_t *rsp)
{
	...
	if(
		xdr_SS_CallBarType_t(xdrs, &rsp->callBarType) &&
		xdr_uchar_ptr_t(xdrs, &rsp->oldPwd) &&
		xdr_uchar_ptr_t(xdrs, &rsp->newPwd) &&
		xdr_uchar_ptr_t(xdrs, &rsp->reNewPwd) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SS_SendUSSDData_Req_t(void* xdrs, CAPI2_SS_SendUSSDData_Req_t *rsp)
{
	...
	if(
		...
		xdr_uchar_ptr_t(xdrs, &rsp->ussdString) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SatkApi_SendTerminalRsp_Req_t(void* xdrs, CAPI2_SatkApi_SendTerminalRsp_Req_t *rsp)
{
	...
	if(
		...
		xdr_pointer(xdrs, (char**)(void*)&rsp->inText,sizeof( SATKString_t ), xdr_SATKString_t) &&
		_xdr_UInt8(xdrs, &rsp->menuID,"menuID") &&
		xdr_copy_len(&len, 128 ) && xdr_bytes(xdrs, (char **)(void*)&rsp->ssFacIePtr, &len, 0xFFFF) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SatkApi_SetTermProfile_Req_t(void* xdrs, CAPI2_SatkApi_SetTermProfile_Req_t *rsp)
{
	...
	if(
		xdr_UInt8(xdrs, &rsp->length) &&
		xdr_copy_len(&len, (u_int)(rsp->length)) && xdr_bytes(xdrs, (char **)(void*)&rsp->data, &len, 0xFFFF) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_PDP_DEACTIVATION_IND_Rsp_t(void* xdrs, CAPI2_PDP_DEACTIVATION_IND_Rsp_t *rsp)
{
	...
	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( PDP_PDPDeactivate_Ind_t ), xdr_PDP_PDPDeactivate_Ind_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
{
	XDR_LOG(xdrs,"CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_NetRegApi_GetTZUpdateMode_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_SimApi_GetAdData_Rsp_t")

	if(
		xdr_AD_DATA_t(xdrs, &rsp->outAdPtr) &&
	1)
		return TRUE;
	else
		return FALSE;
...
{
	XDR_LOG(xdrs,"CAPI2_SimApi_GetCurrentSimVoltage_Rsp_t")

	if(
		 xdr_SimVoltage_t(xdrs, &rsp->val) &&
	1)
		return TRUE;
	else
		return FALSE;
...
{
	XDR_LOG(xdrs,"CAPI2_DATACALL_RELEASE_CNF_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_SS_CALL_FORWARD_STATUS_RSP_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_SS_CALL_BARRING_STATUS_RSP_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_SS_CALL_WAITING_STATUS_RSP_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_USSD_DATA_IND_Rsp_t")
...
{
	XDR_LOG(xdrs,"CAPI2_USSD_CALLINDEX_IND_Rsp_t")

	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( StkReportCallStatus_t ), xdr_StkReportCallStatus_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
{
	XDR_LOG(xdrs,"CAPI2_USSD_SESSION_END_IND_Rsp_t")

	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( CallIndex_t ), xdr_CallIndex_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_MNCC_CLIENT_FACILITY_IND_Rsp_t(void* xdrs, CAPI2_MNCC_CLIENT_FACILITY_IND_Rsp_t *rsp)
{
	...
	if(
		 xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( CC_FacilityInd_t ), xdr_CC_FacilityInd_t) &&
	1)
		return TRUE;
	else
		return FALSE;
