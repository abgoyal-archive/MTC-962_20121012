...
void CAPI2_SMS_StartCellBroadcastWithChnlReq(UInt32 tid, UInt8 clientId, MS_MN_CB_MSG_IDS *cbmi, MS_MN_CB_LANGUAGES *lang)
{
...
void CAPI2_SYS_EnableCellInfoMsg(UInt32 tid, UInt8 clientId, Boolean inEnableCellInfoMsg)
{
	...
	CAPI2_MsDbApi_SYS_EnableCellInfoMsg ( &clientInfo,inEnableCellInfoMsg);
...
void CAPI2_TIMEZONE_SetTZUpdateMode(UInt32 tid, UInt8 clientId, TimeZoneUpdateMode_t mode)
{
	...
	CAPI2_NetRegApi_SetTZUpdateMode ( &clientInfo,mode);
...
void CAPI2_TIMEZONE_GetTZUpdateMode(UInt32 tid, UInt8 clientId)
{
	...
	CAPI2_NetRegApi_GetTZUpdateMode ( &clientInfo);
