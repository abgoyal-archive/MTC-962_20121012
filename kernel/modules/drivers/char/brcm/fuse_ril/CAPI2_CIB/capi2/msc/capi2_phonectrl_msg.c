...
bool_t xdr_Uas_Conn_Info(void* xdrs, Uas_Conn_Info *param)
{
	...
	if(	
		...
		xdr_u_int32_t(xdrs, (u_int32_t *) &param->mask) 
        )		
		return(TRUE);
	else
		return(FALSE);
...
static const struct xdr_discrim CAPI2_MSElement_t_dscrm[] = {
		...
		{ (int)MS_LOCAL_PCH_ELEM_ALLOW_NWI_PDP_ACTIVATION,_T("MS_LOCAL_PCH_ELEM_ALLOW_NWI_PDP_ACTIVATION"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 },
		...
		{ (int)MS_LOCAL_SATK_ELEM_CALL_CONTROL_DEFAULT_CLIR,_T("MS_LOCAL_SATK_ELEM_CALL_CONTROL_DEFAULT_CLIR"), (xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 },
		...
		{ (int)MS_NETWORK_ELEM_UAS_CONN_INFO,_T("MS_NETWORK_ELEM_UAS_CONN_INFO"),				(xdrproc_t)xdr_Uas_Conn_Info, sizeof( Uas_Conn_Info ),		NULL_capi2_proc_t, (xdrproc_t)xdr_Uas_Conn_Info,0 },
		...
		{ (int)MS_SIM_ELEM_RUIM_SUPPORT, _T("MS_SIM_ELEM_RUIM_SUPPORT"),                        (xdrproc_t)xdr_u_char, sizeof( UInt8 ),		NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 },
		...
		{ (int)MS_CFG_ELEM_VCC_OPT_SIM_PIN_CHECK_ENABLED, _T("MS_CFG_ELEM_VCC_OPT_SIM_PIN_CHECK_ENABLED"),	(xdrproc_t)xdr_u_char, sizeof(UInt8), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 }, 
