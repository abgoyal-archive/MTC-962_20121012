...
//***************************************************************************************
/**
	This function returns SIMLOCK with status  by getting the status from the client. 

	@param      clientInfoPtr (in) the client Info
...
void SimLockApi_GetStatus(ClientInfo_t* clientInfoPtr, SIMLOCK_STATE_t *simlock_state, const SIMLOCK_SIM_DATA_t *sim_data, Boolean is_testsim);
