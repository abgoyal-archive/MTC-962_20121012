...
//The following API should not be used any more. It should be replaced by NetRegApi_SetSupportedRatandBand() as declared above.
//Once all the calling entities in ATC/MMI replace the below API with the above, the following API will be deleted in CAPI.
