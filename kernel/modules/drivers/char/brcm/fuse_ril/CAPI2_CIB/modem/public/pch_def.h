...
typedef struct
{
	...
	PCHDNSAddr_t	v6dnsPri;
	PCHDNSAddr_t	v6dnsSec;
	PCHDSMIPAddr_t	v6haAddr;
	PCHDSMIPAddr_t	v6hnPrefix;
	PCHDSMIPAddr_t	v6v4haAddr;
...
#define DNS_SERVER_IPV6_ADDR				0x0003
...
// IDs for requesting IPv6 Home Agent Prefix and Address
#define ID_DSMIPV6_HOME_AGENT_ADDR			0x0007
#define ID_DSMIPV6_HOME_NETWORK_PREFIX		0x0008
#define ID_DSMIPV6_IPV4_HOME_AGENT_ADDR		0x0009
