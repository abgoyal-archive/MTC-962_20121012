...
typedef IPC_ReturnCode_T	(*IPC_EventWaitFPtr_T)		(void * Event, IPC_U32 MilliSeconds);
...
//**************************************************
typedef void		(*IPC_FlowCntrlFPtr_T)				(IPC_BufferPool Pool, IPC_FlowCtrlEvent_T Event);
