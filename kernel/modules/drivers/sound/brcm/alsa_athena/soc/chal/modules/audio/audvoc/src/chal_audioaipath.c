	   ...
	   )
{
	if (enable==TRUE)
	{
        ...
        //enable ADC1 SW without enabling Voice Out
	...
	else
	{
        ...
        //disable ADC1 SW without enabling Voice Out
	    BRCM_WRITE_REG_FIELD( sAIPath.base, DSP_AUDIO_AUDIOLOOPBACK_CTRL_R, RXANA1_EN, 0 );
	}
}
