...
//--- BASE INFO
#define BCM2141_BASE		0x02000000
#define SRAM_BASE			0x06000000
#define	SRAM1_BASE			0x07000000  // start of SRAM1 block
#define ROM_BASE			0x00000000

//--- SDRAM BASE INFO
#define SDRAM_BASE			0x80000000
// SDRAM_RW_BASE must be defined in a platform file
...
//--- Power up mode register
#if defined(_HERA_) || defined (_RHEA_)
#define PUMR_REG				(0x35003000+BYTE_1_OFFSET)		// 8-bit register with a 32-bit base address 0x08880018
#else
