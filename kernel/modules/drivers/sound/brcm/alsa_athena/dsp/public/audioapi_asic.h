...
*
*   @brief  This file contains the ASIC Audio API definitions.
*
****************************************************************************/
/**
...
AudioApp_t AUDIO_GetAudioProfile( void );

void		AUDIO_PreSwitchModeSetting(void);
void		AUDIO_PostSwitchModeSetting(void);

/**
*	@brief	return current audio operation.
*
*   @return Result_t
*/
AudioApp_t	AUDIO_GetAudioApp(void);
/**
*	@brief	set current audio application.
*
*   @return Result_t
*/
void		AUDIO_ASIC_SetAudioApp(AudioApp_t aud_app);
